defmodule ProductIdifyTest do
  ...
  test 'idify' do
    ...
    {_, bundle} = get_json("test/fixtures/bundle.json")
    ...
    expected_result = ["/product/products/allflex-premium-calf-pack",
                       "urn:lic:predicate:responsible_party", "urn:lic:predicate:owning_party",
                       ...
                       "urn:lic:id:confreq:species", "urn:lic:id:confreq:nait_number",
